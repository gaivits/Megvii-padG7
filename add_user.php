...
<body>
	...
	<form id="calcform" name="calcform" action="add_form.php" method="POST">
		...
		<div class="form-group">
			...
			<div id="imgdiv"><img src="/lib/icons/material/svg/photo_white_24dp.svg" loading="lazy" width="240" height="180" alt="">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<textarea id="out1" rows="5"  cols="60" readonly class="form-control" value="OnEncode()"></textarea>
		</div>
